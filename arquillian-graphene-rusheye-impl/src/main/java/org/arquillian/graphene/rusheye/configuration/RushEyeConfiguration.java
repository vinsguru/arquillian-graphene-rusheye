...
public class RushEyeConfiguration extends Configuration{
	...
	public Path getPatternDefaultPath(){
		return this.getDefaultPath().resolve(getProperty("snapshotPath", this.snapshotPath));
	}
	...
	public Path getResultDefaultPath(){
		return this.getDefaultPath().resolve(getProperty("resultPath", this.resultPath));
	}
