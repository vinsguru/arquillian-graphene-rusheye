...
public class RichFacesTest extends Arquillian {
    ...
    private final static String SNAPSHOT_PATH = "src/main/resources/snapshot/";
    private final static String RESULT_PATH = "src/main/resources/result/";
    ...
    @Test(dependsOnMethods = { "richFaceSimilarityTest" })
